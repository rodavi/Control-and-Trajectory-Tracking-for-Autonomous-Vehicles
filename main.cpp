...
int main ()
{
  ...
  **/
  ...
  pid_steer.Init(0.15, 0.003, 0.55, 1.2, -1.2);
  //0.46, 0.0156, 0.0001,
...
//           // Update the delta time with the previous command
          ...
          **/
          double curr_yaw = yaw;
          double desired_steer = -atan2(y_points[y_points.size()-1]-y_position, x_points[x_points.size()-1]-x_position);
          
          double ac_st = yaw;
          
          error_steer = desired_steer-ac_st;
        std::cout << "ang: "<< desired_steer<<" current yaw: "<<ac_st<<" er: "<<error_steer<<"\n";
...
//           // Update the delta time with the previous command
        ...
        std::cout <<"error Th: "<< error_throttle<<"\n";
